...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    function _balanceOf(address _owner) public view returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function _transferFrom(address _from, address _to, uint _value) public onlyPayloadSize(3 * 32) {
    ...
    */
    function _approve(address _spender, uint _value) public onlyPayloadSize(2 * 32) {
    ...
    */
    function _allowance(address _owner, address _spender) public view returns (uint remaining) {
