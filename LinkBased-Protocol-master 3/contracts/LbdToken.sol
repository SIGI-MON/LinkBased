...
contract LbdToken is ERC20UpgradeSafe, ERC677Token, OwnableUpgradeSafe {
        ...
        initializer
    {
        ...
        BIG_TRANSFER_PERCENTAGE = 150;
        SMALL_TRANSFER_PERCENTAGE = 150;

        // Initially set provided multis as big/small transfer fee wallets (currently, small & big take same, 1.5%)
        bigTransferFeeWallet = address(0x6f82B1d99643DdD7d2411D9A87931cF2B049bA02);
        smallTransferFeeWallet = address(0x47e7088d8253b86242428fe9C42B9320Adfcbbc8);
